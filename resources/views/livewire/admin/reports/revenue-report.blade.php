<div>
    ...
    {{-- Credit notes & net revenue --}}
    <div class="mb-6 grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div class="card p-5"><span class="text-sm text-gray-500 dark:text-gray-400">Credit Notes Issued</span><p class="mt-2 text-xl font-semibold text-red-500">− {{ money($creditNotesIssued) }}</p></div>
        <div class="card p-5"><span class="text-sm text-gray-500 dark:text-gray-400">Credit Applied</span><p class="mt-2 text-xl font-semibold text-gray-900 dark:text-white">{{ money($creditNotesApplied) }}</p></div>
