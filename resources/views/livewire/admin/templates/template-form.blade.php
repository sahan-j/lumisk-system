<div>
    <form wire:submit="save">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <a href="{{ route('admin.invoice-templates.index') }}" wire:navigate class="mb-1 inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gold dark:text-gray-400">
            ...
            <div class="flex gap-3">
                <a href="{{ route('admin.invoice-templates.index') }}" wire:navigate class="btn-secondary">Cancel</a>
                ...
                <div class="card p-5">
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            ...
                            <input wire:model="name" type="text" placeholder="e.g. Website Basic Package" class="form-input-base">
                            @error('name') <p class="mt-1 text-xs text-red-500">{{ $message }}</p> @enderror
                        </div>
                        <div class="sm:col-span-2">
                            <label class="form-label">Description</label>
                            <input wire:model="description" type="text" placeholder="Optional short description" class="form-input-base">
                        </div>
                        <div>
                            <label class="form-label">Type</label>
                            <select wire:model="type" class="form-input-base">
                                <option value="both">Invoice & Estimate</option>
                        ...
                        <div>
                            ...
                            <select wire:model="currencyCode" class="form-input-base">
                ...
                <div class="card p-5">
                    ...
                    <div class="space-y-3">
                        @foreach ($items as $index => $item)
                            <div wire:key="titem-{{ $index }}" class="rounded-lg border border-gray-200 p-3 dark:border-ink-600">
                ...
                <div class="card p-5">
                    ...
                    <div class="space-y-3 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900 dark:text-white">{{ $currencyCode }} {{ number_format($this->subtotal, 2) }}</span>
                        </div>
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900 dark:text-white">{{ $currencyCode }} {{ number_format($this->taxAmount, 2) }}</span>
                        </div>
                        <div class="flex items-center justify-between gap-2">
                        ...
                        <div class="flex justify-between border-t border-gray-200 pt-3 dark:border-ink-600">
                            ...
                            <span class="text-lg font-semibold text-gold">{{ $currencyCode }} {{ number_format($this->total, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
