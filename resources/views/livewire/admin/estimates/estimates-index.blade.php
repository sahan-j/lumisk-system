                ...
                <tbody class="divide-y divide-gray-100 dark:divide-ink-700">
                    @forelse ($estimates as $estimate)
                        <tr class="hover:bg-gray-50 dark:hover:bg-ink-800">
                            <td class="px-5 py-3">
                                <a href="{{ route('admin.estimates.show', $estimate) }}" class="font-medium text-gray-900 hover:text-gold dark:text-white">{{ $estimate->estimate_number }}</a>
                            </td>
                            ...
                            <td class="px-5 py-3">
                                <div class="flex items-center justify-end gap-1">
                                    ...
                                    <button wire:click="duplicate({{ $estimate->id }})" class="rounded p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-700 dark:hover:bg-ink-700" title="Duplicate">
                    ...
                    @empty
                        <tr><td colspan="7" class="px-5 py-12 text-center text-sm text-gray-400">No estimates found.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
