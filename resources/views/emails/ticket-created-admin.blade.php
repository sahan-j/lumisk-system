...
<div class="wrapper">
  <div class="header">
    ...
    <div class="header-sub">New support ticket received</div>
  </div>
  <div class="body">
    <div class="detail-box">
      ...
      <div class="detail-row"><span class="detail-label">Type</span><span class="detail-value">{{ $ticket->typeLabel() }}</span></div>
      <div class="detail-row"><span class="detail-label">Priority</span><span class="detail-value">{{ ucfirst($ticket->priority) }}</span></div>
      <div class="detail-row"><span class="detail-label">Client</span><span class="detail-value">{{ $ticket->client->name }}</span></div>
    </div>

    @if($messageBody)
      <p style="font-size:12px; color:#94a3b8; margin:0 0 6px;">Message</p>
