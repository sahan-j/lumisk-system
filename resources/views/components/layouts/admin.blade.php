            ...
            <nav class="flex-1 overflow-y-auto p-3">
                ...
                @foreach ($navGroups as $groupLabel => $items)
                    ...
                    @if (count($visibleItems) > 0)
                        @if (! $isFirst)
                            <div style="border-top: 0.5px solid #1e1e1e; margin: 6px 0;"></div>
                        @endif
                        <div style="font-size: 9.5px; text-transform: uppercase; letter-spacing: 1.2px; color: #4a4a4a; padding: 10px 8px 5px;">{{ $groupLabel }}</div>
