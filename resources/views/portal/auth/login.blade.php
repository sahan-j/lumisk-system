<x-layouts.guest title="Client Login">
    <div class="mb-8">
        ...
        <h2 class="mt-2 text-2xl font-semibold text-gray-900 dark:text-white">Sign in to your portal</h2>
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Access your invoices and estimates.</p>
    </div>
    ...
    <form method="POST" action="{{ route('portal.login.store') }}" class="space-y-5">
        ...
        <div>
            ...
            <div class="relative" x-data="{ show: false }">
                <input x-ref="input" id="password" name="password" type="password" required
