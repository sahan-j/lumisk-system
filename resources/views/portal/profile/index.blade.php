            ...
            <form method="POST" action="{{ route('portal.profile.password') }}" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <input x-ref="input" id="current_password" name="current_password" type="password" required class="form-input-base pr-10">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <input x-ref="input" id="password" name="password" type="password" required class="form-input-base pr-10" placeholder="Minimum 8 characters">
                        <button type="button" tabindex="-1"
                                @click="show = !show; $refs.input.type = show ? 'text' : 'password'"
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-brand-purple focus:outline-none"
                                aria-label="Toggle password visibility">
                ...
                <div>
                    ...
                    <div class="relative" x-data="{ show: false }">
                        <input x-ref="input" id="password_confirmation" name="password_confirmation" type="password" required class="form-input-base pr-10">
                        <button type="button" tabindex="-1"
                                @click="show = !show; $refs.input.type = show ? 'text' : 'password'"
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-brand-purple focus:outline-none"
                                aria-label="Toggle password visibility">
